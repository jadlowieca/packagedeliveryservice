...
truck1 = Truck(16, 18, None, [1, 13, 14, 15, 19, 16, 20, 29, 30, 31, 34, 37, 40], 0.0, "4001 South 700 East", departure_time_truck1)

departure_time_truck2 = datetime.strptime("9:05 AM", "%I:%M %p")
truck2 = Truck(16, 18, None, [2, 3, 4, 5, 6, 7, 8, 10, 18, 23, 25, 26, 27, 28, 36, 38], 0.0, "4001 South 700 East", departure_time_truck2)

departure_time_truck3 = datetime.strptime("12:30 PM", "%I:%M %p")
truck3 = Truck(16, 18, None, [9, 11, 12, 17, 21, 22, 24, 32, 33, 35, 39], 0.0, "4001 South 700 East", departure_time_truck3)
